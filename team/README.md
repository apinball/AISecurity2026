...
| (LF 담당자) | **LF** (Low Frequency, additive frequency-domain trigger) | `team/lf/LF_코드_변경사항_보고서.{docx,pdf}` |
...
| 4 | `utils/bd_img_transform/patch.py:56,62` | `np.float → float` | LF 담당자 | NumPy 2.0 alias 삭제, additive trigger 적용 시 필요 |
